...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.CharField(default='PAYE', max_length=100)),
                ('type', models.CharField(choices=[('income', 'income'), ('deduction', 'deduction')], default='deduction', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('emp_id', models.CharField(default='emp930194', max_length=70)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('advance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='payroll', to='management.cashadvance')),
                ('deductions', models.ManyToManyField(related_name='payroll', to='management.Deductions')),
